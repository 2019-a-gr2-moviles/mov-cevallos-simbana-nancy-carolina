...
import com.example.ejemploparcelable.Persona
import com.example.ejemploparcelable.R
import com.example.ejemploparcelable.ReciclerViewActivity
...
class AdaptadorPersona(
    ...
    override fun getItemCount(): Int {//tamaño de la lista
    ...
    override fun onCreateViewHolder(//seleccionamos el layout
        p0: ViewGroup, p1: Int):
